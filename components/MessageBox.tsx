...
export default function MessageView(props: Properties) {
	...
	return (
		<div className="flex flex-col gap-5 justify-end content-end grow-1 bg-blue-300 text-gray-900 rounded-xl p-10 mx-auto h-full w-full max-w-lg lg:max-w-full min-h-screen lg:min-h-0 overflow-clip">
