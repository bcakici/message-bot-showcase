...
export default function MessageView(props: Properties) {
	...
	return (
		<div className="flex flex-col gap-5 justify-end content-end grow-1 bg-blue-300 text-gray-900 rounded-xl p-10 mx-auto w-full max-w-lg lg:max-w-full min-h-[40rem] lg:min-h-0 lg:h-full overflow-clip">
